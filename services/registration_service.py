...
class RegistrationService:
    ...
    def recommend_courses(self, student_id, quiz_results=None):
        ...
        if shell_grade is not None:
            adjusted_grades['shell'] = shell_grade
        if shell_grade is None and 'Intro to Shell and Linux Scripting' in quiz_results:
            ...
            adjusted_grades['shell'] = max(shell_grade, quiz_results['Intro to Shell and Linux Scripting']['score'])
        else:
            adjusted_grades['shell'] = shell_grade or 0
        if python_grade is not None:
            adjusted_grades['python'] = python_grade
